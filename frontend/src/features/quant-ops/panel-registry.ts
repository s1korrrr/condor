...
export const CAPITAL_PANELS = [...ORIGINAL_CAPITAL_PANELS, 'C17','C18','C19','C20','C21','C22','C23','C24'] as const;
export const BOT_PANELS = [...ORIGINAL_BOT_PANELS, 'B26','B27','B28','B29','B30','B31','B32','B33','B34'] as const;
